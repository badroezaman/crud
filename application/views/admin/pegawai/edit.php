    ...
    <div class="panel-body">
        ...
        <div class="tab-content">
            <div id="datadiri">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select data-placeholder="Pilih Agama" class="select-clear" name="agama" required>
                                    <?php $agm = $this->db->where('agama')->get('agama')->result(); ?>
                                    <option></option>
                                    <?php
                                    foreach ($agm as $ag) :;
                ...
                <div class="col-md-12">
                    <div class="text-center">
                        <button type="submit" href="#pekerjaan" name="btn_datadiri" id="btn_datadiri" class="btn btn-primary">Lanjut</button>
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
            ...
            <!-- <div id="pekerjaan">
                ...
                <div class="col-md-12">
                    <div class="text-center">
                        <button type="submit" href="#datadiri" name="back_btn_datadiri" id="back_btn_datadiri" class="btn btn-default">Kembali</button>
                        <button type="submit" href="#pendidikan" name="btn_pendidikan" id="btn_pendidikan" class="btn btn-primary">Lanjut</button>
                    </div>
                </div>
            </div>
